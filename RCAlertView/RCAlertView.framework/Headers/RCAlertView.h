...
//! Project version number for RCAlertView.
FOUNDATION_EXPORT double RCAlertViewVersionNumber;

//! Project version string for RCAlertView.
FOUNDATION_EXPORT const unsigned char RCAlertViewVersionString[];
